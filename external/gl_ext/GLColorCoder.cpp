...
void GLColorCoder::getcolor(std::uint32_t p, std::uint32_t np, float&r, float&g, float&b) 
{
    float inc = 6.0 / np;
    float x = p * inc;
...
//static 
void GLColorCoder::CPF2Color( std::vector<uint32_t>& desc, std::vector<glm::vec3>& colors)
{
