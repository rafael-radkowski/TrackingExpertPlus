	...
	*/
	...
	public:
		...
		*/
		...
		std::vector<Eigen::Affine3f >& getPoseCandidates(void);

		//std::vector< std::vector<Eigen::Affine3f> >& getPoseCluster(void);
		//std::vector< std::pair<int, int> >& getPoseClusterVotes(void);
	...
	public:
		...
		std::vector< Eigen::Affine3f >& getPoses(void);
		std::vector<int >& getPoseVotes(void);
	...
	public:
		...
		*/
		CPFClusteringData* GetClusteringData(void);
	...
	private:
		...
		// the resuting data from the clustering process. 
		CPFClusteringData* clustring_data;
