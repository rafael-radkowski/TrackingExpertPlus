#pragma once
/*
@class CPFMatchingExp(erimental)

@brief The class implements a feature detector which is based on curvature values of a surface object
and the curvature distribution on the surface. It uses a generalized Hough Transform as a voting schema to 
identify the best matches in a point set. 
